...
from src.microgrid.residence.residential_parameters import MicrogridConfig
from src.microgrid.residence.residential_components import Battery, PVArray, Generator, Load, ComponentState
from src.ems.residence_ems import ResidenceEMS as EnergyManagementSystem, OperationMode, MicrogridMeasurements
...
class MicrogridSimulator:
    ...
    # Initialize EMS
        ...
        logger.info("Residential microgrid simulator initialized")
        ...
        logger.info(f"Residents will experience service degradation during outages")
    ...
    def step(self, grid_available: bool = True, 
        ...
        data_point = {
            ...
            'grid_power_kw': max(0.0, total_load - (pv_power + gen1_power + self.battery.power_kw)),
            ...
            'power_balance_kw': pv_power + gen1_power + self.battery.power_kw - total_load,
    ...
    def run_scenario(self, 
        ...
        logger.info(f"Running residential scenario: {duration_hours}h duration, {num_steps} steps")
        if outage_start_hour is not None:
            ...
            logger.info("Expect significant resident discomfort")
    ...
    def run_solar_scenario(self,
        ...
        logger.info(f"🏠 Running residential SOLAR scenario: {duration_hours}h, "
...
def main():
    ...
    from residential_parameters import create_default_config
    ...
    logger.info("Resident discomfort quantified")
