...
from src.microgrid.Industry_microgrid.industrial_parameters import MicrogridConfig
from src.microgrid.Industry_microgrid.industrial_component import Battery, PVArray, Generator, Load, ComponentState
from src.ems.industry_ems import IndustryEMS as EnergyManagementSystem, OperationMode, MicrogridMeasurements
...
class MicrogridSimulator:
    ...
    def run_solar_scenario(self,
        ...
        logger.info(f"🏭 Running industrial SOLAR scenario: {duration_hours}h, "
