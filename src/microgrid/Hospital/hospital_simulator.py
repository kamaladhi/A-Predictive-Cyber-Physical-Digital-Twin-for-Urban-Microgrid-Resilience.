...
from src.microgrid.Hospital.hospital_parameter import MicrogridConfig
from src.microgrid.Hospital.hospital_component import Battery, PVArray, Generator, Load, ComponentState
from src.ems.hospital_ems import HospitalEMS as EnergyManagementSystem, OperationMode, MicrogridMeasurements
...
class MicrogridSimulator:
    ...
    def step(self, grid_available: bool = True, 
        ...
        # Apply city-level shed command to non-critical load
        ...
        # Build measurements for EMS (legacy shim)
    ...
    def run_solar_scenario(self,
        ...
        Args:
            ...
            start_time: Simulation start time (datetime); if None, defaults to
                        midnight today.
        ...
        logger.info(f"🏥 Running hospital SOLAR scenario: {duration_hours}h, "
...
def main():
    ...
    from src.microgrid.Hospital.hospital_parameter import create_default_config
