...
from Microgrid.Hospital.microgrid_component import Battery, PVArray, Generator, Load, ComponentState
from Microgrid.Hospital.microgrid_ems import EnergyManagementSystem, OperationMode
...
class MicrogridSimulator:
    ...
    def __init__(self, config: MicrogridConfig):
        ...
        self.ems = EnergyManagementSystem(config, self.battery, self.pv, 
                                         self.generator1, self.generator2, self.load)
