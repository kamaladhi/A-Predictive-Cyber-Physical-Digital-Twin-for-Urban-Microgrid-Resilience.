...
class EnergyManagementSystem:
    ...
    def load_shedding_strategy(self, power_deficit_kw: float) -> float:
        ...
        if power_deficit_kw > 0:
            self.log_event(
                "critical_warning",
                f"WARNING: Cannot shed more. Deficit {power_deficit_kw:.1f} kW remains. Critical loads at risk!"
            )
    ...
    def generator_dispatch_strategy(self):
        ...
        """
        from Microgrid.Industry_microgrid.industrial_component import ComponentState
        ...
        if self.generator2.state == ComponentState.OFF:
            ...
            if (soc >= 75 and
                ...
                self.log_event('gen2_stop', 'GEN2 stopped')
